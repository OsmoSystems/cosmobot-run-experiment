...
class TestGenerateStastics():
    ...
    @pytest.mark.parametrize("name, color_channel_index, expected_color_channel_underexposed_percent", [
    ...
    def test_underexposed_percent_by_color_channel(
        ...
        stats = module._generate_statistics(rgb_image)
        actual_color_channel_underexposed_percent = stats[color_channel_index]
