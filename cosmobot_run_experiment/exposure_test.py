...
rgb_image = np.array(
    [[[0.0, 0.1, 0.2], [0.1, 0.2, 0.0]], [[0.0, 0.1, 0.999], [0.0, 0.999, 0.999]]]
)
...
class TestGenerateStastics:
    ...
    @pytest.mark.parametrize(
        "color_channel_key, expected_invalid_exposure_percent",
        [
    ...
    def test_exposure_percent_by_color_channel(
        self, color_channel_key, expected_invalid_exposure_percent
    ):
        stats = module._generate_statistics(rgb_image)
