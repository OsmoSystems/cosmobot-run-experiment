...
class TestSyncToS3:
    def test_syncs_to_subdirectory_in_s3_bucket(self, mocker, mock_check_call, mock_path_basename):
        ...
        expected_command = 'sudo AWS_SHARED_CREDENTIALS_FILE=/home/pi/.aws/credentials /home/pi/.local/bin/aws s3 sync /output_dir/experiment_name s3://camera-sensor-experiments/experiment_name '
    ...
    @pytest.mark.parametrize("test_name, erase_synced_files, expected_command", [
        (
            'mv',
            True,
            'sudo AWS_SHARED_CREDENTIALS_FILE=/home/pi/.aws/credentials /home/pi/.local/bin/aws s3 mv --recursive /output_dir/experiment_name s3://camera-sensor-experiments/experiment_name '
        ),
        (
            'sync',
            False,
            'sudo AWS_SHARED_CREDENTIALS_FILE=/home/pi/.aws/credentials /home/pi/.local/bin/aws s3 sync /output_dir/experiment_name s3://camera-sensor-experiments/experiment_name '
        )
    ])
